...
public class EventRegisterActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    EditText addtitle, et_date, adddescription;
                ...
                if (ValidateData()) {
                    try {
                        if (event_bitmap != null) {
                            ...
                            AdminEventRegistration register = new AdminEventRegistration(id, title, description, Utils.BitMapToString(event_bitmap), date);
                            databaseAdmin.child(id).setValue(register);
                            Toast.makeText(EventRegisterActivity.this, "Posted Successfully!!", Toast.LENGTH_LONG).show();
                        } else {
                            Toast.makeText(EventRegisterActivity.this, "Please select image!", Toast.LENGTH_LONG).show();
                        }
    ...
    private void Init() {
        databaseAdmin = FirebaseDatabase.getInstance().getReference().child("AdminEventRegistration");
    ...
    private boolean ValidateData() {
        ...
        if (adddescription.getText().toString().trim().equals("")) {
